        ...
        window.onload = function() {
            ...
            itemsBlogShowmore.forEach((el => {
                ...
                if (getCurrrentWidth > currentListItem.clientWidth && window.innerWidth > 1100) {
                    ...
                    [ ...currentContentList ].splice(3, currentContentList.length - 1).forEach((el => el.setAttribute("hidden", true)));
                    button.className = "item-blog-showmore__more-btn";
                    button.textContent = "ещё...";
                    button.onclick = event => {
                        [ ...currentContentList ].splice(3, currentContentList.length - 1).forEach((el => el.removeAttribute("hidden")));
                        event.target.remove();
                    };
